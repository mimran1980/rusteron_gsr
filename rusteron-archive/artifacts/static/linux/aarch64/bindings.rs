...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of aeron_archive_stct"][::std::mem::size_of::<aeron_archive_stct>() - 136usize];
    ...
    ["Offset of field: aeron_archive_stct::archive_proxy"]
        [::std::mem::offset_of!(aeron_archive_stct, archive_proxy) - 64usize];
    ["Offset of field: aeron_archive_stct::owns_control_response_subscription"]
        [::std::mem::offset_of!(aeron_archive_stct, owns_control_response_subscription) - 72usize];
    ["Offset of field: aeron_archive_stct::subscription"]
        [::std::mem::offset_of!(aeron_archive_stct, subscription) - 80usize];
    ["Offset of field: aeron_archive_stct::control_response_poller"]
        [::std::mem::offset_of!(aeron_archive_stct, control_response_poller) - 88usize];
    ["Offset of field: aeron_archive_stct::recording_descriptor_poller"]
        [::std::mem::offset_of!(aeron_archive_stct, recording_descriptor_poller) - 96usize];
    ...
    ["Offset of field: aeron_archive_stct::control_session_id"]
        [::std::mem::offset_of!(aeron_archive_stct, control_session_id) - 112usize];
    ["Offset of field: aeron_archive_stct::archive_id"]
        [::std::mem::offset_of!(aeron_archive_stct, archive_id) - 120usize];
    ["Offset of field: aeron_archive_stct::is_in_callback"]
        [::std::mem::offset_of!(aeron_archive_stct, is_in_callback) - 128usize];
};
