...
run-aeron-archive-driver:
  java \
    ...
    -javaagent:../rusteron-archive/aeron/aeron-agent/build/libs/aeron-agent-1.48.5.jar \
    -cp ../rusteron-archive/aeron/aeron-all/build/libs/aeron-all-1.48.5.jar:../rusteron-archive/aeron/aeron-archive/build/libs/aeron-archive-1.48.5.jar \
